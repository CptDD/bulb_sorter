...
public:
	...
	static void pass_filter_real(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud,pcl::PointCloud<pcl::PointXYZ>::Ptr filtered_cloud)
	{
		pcl::PassThrough<pcl::PointXYZ> pass_filter;
		pass_filter.setInputCloud(cloud);
		pass_filter.setFilterFieldName("z");
		pass_filter.setFilterLimits(0.3,0.5);
		pass_filter.filter(*filtered_cloud);

		pass_filter.setInputCloud(filtered_cloud);
		pass_filter.setFilterFieldName("x");
		pass_filter.setFilterLimits(0.4,0.73);
		pass_filter.filter(*filtered_cloud);

		pass_filter.setInputCloud(filtered_cloud);
		pass_filter.setFilterFieldName("y");
		pass_filter.setFilterLimits(0.6,0.8);
		pass_filter.filter(*filtered_cloud);
